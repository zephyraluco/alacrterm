...
use crate::{FontFamilyName, FontFeaturesContent, FontSize, FontWeightContent, ShowScrollbar};
...
pub enum TerminalBlink {
    ...
    Off,
    /// Default the cursor blink to off, but allow the terminal to set blinking.
    TerminalControlled,
...
#[derive(
    Clone, Debug, Serialize, Deserialize, PartialEq, Eq, JsonSchema, strum::EnumDiscriminants,
)]
