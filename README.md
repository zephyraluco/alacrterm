...
| GPUI | latest | GUI 框架（来自 Zed） |
| gpui-component | latest | UI 组件库（来自 Longbridge） |
| Alacritty Terminal | 0.26 | 终端模拟核心 |
| Tokio | 1.x | 异步运行时 |
| Sysinfo | 0.39 | 系统和进程信息 |
| Rust-embed | 8 | 资源嵌入 |
...
│   │       ├── themes.rs       # 主题系统
│   │       ├── layout.rs       # 布局定义
│   │       ├── terminal_view.rs   # 终端视图组件
│   │       └── terminal_element.rs # 终端渲染元素
│   │
│   └── terminal/               # 终端核心库 crate
│       └── src/
│           ├── lib.rs          # 终端库主入口
